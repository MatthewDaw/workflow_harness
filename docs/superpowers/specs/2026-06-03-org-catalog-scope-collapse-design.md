...
- New ProjectSkills.tsx: lists `project.enabledSkills`; add via SkillCombobox (org catalog, searchable, author-filterable) -> `POST /projects/:id/skills/:name`; remove -> `DELETE`.
