...
$waves = @(
  ...
  # --- R3 reforms (plans 008->009->010), scheduled BEFORE the 007/U5b human gate so they run autonomously. Max-width, file-disjoint waves. ---
  ,@("008/U1","008/U2","008/U4")
  ,@("008/U3")
  ,@("008/U5")
  ,@("008/U6","009/U1","009/U2","009/U6")
  ,@("008/U7","008/U8","009/U3")
  ,@("008/U9","009/U4")
  ,@("009/U5","009/U8")
  ,@("009/U7")
  ,@("009/U9")
  ,@("010/U1","010/U2","010/U3")
  ,@("007/U5b")
  ,@("007/U6")
  ,@("007/U7")
  ,@("007/U8")
