...
name: ci_describe_pr
description: >-
  Generate comprehensive PR descriptions following repository templates. Use when the user says "/ci_describe_pr" or asks to run the ci describe pr workflow.
---
