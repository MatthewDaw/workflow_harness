...
type View interface {
	...
	// Scrollback returns lines evicted off the top of the default screen,
	// oldest-first. The claude+ fork retains these for a scrollback viewport;
	// upstream vt10x discarded them.
	Scrollback() [][]Glyph
