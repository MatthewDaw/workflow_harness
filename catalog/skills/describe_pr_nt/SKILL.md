...
name: describe_pr_nt
description: >-
  Generate comprehensive PR descriptions following repository templates. Use when the user says "/describe_pr_nt" or asks to run the describe pr nt workflow.
---
